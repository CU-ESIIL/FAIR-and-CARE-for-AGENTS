---
title: Before agents act
description: A scientific Perspective on specifying reliable and governable environmental-science work before a computer acts.
hide:
  - navigation
  - toc
---
...
FAIR makes scientific objects findable, accessible, interoperable, and reusable. CARE was created for Indigenous Data Governance and retains that continuing purpose. A separate general governance gate asks who benefits or bears risk, who has authority, who is accountable, and which relationships or obligations constrain the work. That gate is not CARE and cannot replace Indigenous laws, protocols, institutions, or decisions.
...
<div class="workflow" role="list" aria-label="Pre-delegation scientific workflow">
  ...
  <span role="listitem"><strong>Evaluation</strong><small>Define success, error, proper refusal, and authorized review.</small></span>
...
**When Indigenous Peoples or Indigenous data are involved, who holds the relevant authority and what protocols govern the work?**

Follow the full Indigenous Data Governance framework and the laws, protocols, representative institutions, and decisions of the relevant Indigenous People.

</div>

<div class="principle-card principle-card--test" markdown>

### General governance gate

**What may this workflow do, who decides, and where must it stop?**

Make benefit and burden, authority, accountability, relationships, and release decisions explicit. Technical evidence can support this gate but cannot create legitimate authority.
...
The current manuscript also has a version-controlled [Ecology author-guidelines and submission-readiness checklist](ecology-author-guidelines.md). Its derived Ecology PDF is a review-layout proof; editorial invitation, author declarations, and an allowed Word or genuine LaTeX submission package remain required.
