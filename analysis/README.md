...
For this manuscript project, the named reproducible result is the current second-draft PDF, its Ecology formatting proof, and its citation-integrity and word-count report. The canonical sources are the Markdown manuscript, Ecology submission metadata, and citation-review registry; the PDFs and report are derived products.
